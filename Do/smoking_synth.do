...
cd "C:\Users\barth\OneDrive\Desktop\Smoking\Data"
capture log close
...
synth  	cigsale 
		cigsale(1988) cigsale(1980) cigsale(1975) cigsale(1988)
		beer(1984(1)1988) lnincome age15to24 
		retprice
		,		
...
* Drop the outliers (RMSPE is 5 times more than Ca: drops 29, 13, 24, 34, 39, 22)
* Picture of the full sample, including outlier RSMPE
#delimit;	
